# T1 Search Quality Snapshot (sqlite-vec)
...
- MRR: `0.089`
- Queries: `15`
- JSON: `bechmarks/T1/2026-03-05-recall5-ground-truth.json`
- Log: `bechmarks/T1/2026-03-05-recall5-ground-truth.log`
...
- Hit@1: `80.0% (4/5)`
- Hit@5: `100.0% (5/5)`
- Log: `bechmarks/T1/2026-03-05-quality-click-semantic.log`
...
- Log: `bechmarks/T1/2026-03-05-quality-pqueue-semantic.log`

## How To Compare Future T1 Feature Runs

- Keep the same benchmark speed command from `bechmarks/T1/2026-03-05-sqlite-vec-baseline.md`.
