# T1 Search Quality Snapshot (T1 #2 comprehension gap loop)
...
- Result: `18 passed`
- Log: `bechmarks/T1/2026-03-05-t1-2-comprehension-gap-benchmark-harness.log`
...
- JSON: `bechmarks/T1/2026-03-05-t1-2-comprehension-gap-recall5.json`
- Log: `bechmarks/T1/2026-03-05-t1-2-comprehension-gap.log`
...
- Hit@1: `80.0% (4/5)`
- Hit@5: `100.0% (5/5)`
- Log: `bechmarks/T1/2026-03-05-t1-2-comprehension-gap-quality-click.log`
...
- Log: `bechmarks/T1/2026-03-05-t1-2-comprehension-gap-quality-pqueue.log`

## Comparison Anchor

- Previous feature snapshot: `bechmarks/T1/2026-03-05-t1-1-conceptual-layer-search-quality.md`
- Use with `bechmarks/T1/2026-03-05-t1-2-comprehension-gap-baseline.md` to decide next action.
